...
export default class ManageJob extends React.Component {
    ...
    loadData(callback) {
        ...
        var link = 'http://mvpcompetitiontalentlist.azurewebsites.net/listing/listing/getSortedEmployerJobs?' + this.getSortedJobsParams();
    ...
    handleCloseJob(jobData) {
        ...
        this.setState({ loaderData: loader}, () => {
            $.ajax({
                url: 'http://mvpcompetitiontalentlist.azurewebsites.net/listing/listing/closeJob',
                headers: {
